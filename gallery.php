            ...
            <div class="slider-container">
                <div class="slider">
                    <div class="slides" index=0>
                        <img class="slider-img" src="img/carousel-1.jpg" />
                    </div>
                    <div class="slides" index=1>
                        <img class="slider-img" src="img/carousel-2.jpg" />
                    </div>
                    <div class="slides" index=2>
                        <img class="slider-img" src="img/carousel-3.jpg" />
                    </div>
                    <div class="slides" index=3>
                        <img class="slider-img" src="img/carousel-4.jpg" />
                    </div>
                    <div class="slides" index=4>
                        <img class="slider-img" src="img/carousel-5.jpg" />
                    </div>
                    <div class="slides" index=5>
                        <img class="slider-img" src="img/carousel-6.jpg" />
                    </div>
                </div>
                <div class="buttons">
